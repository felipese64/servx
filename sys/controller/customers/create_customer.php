...
$customer->setCustomer_adress_type($_POST['customer_adress_type']);
$customer->setCustomer_adress($_POST['customer_adress']);
$customer->setCustomer_adress_complements($_POST['customer_adress_complements']);
