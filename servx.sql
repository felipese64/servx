...
CREATE TABLE `tbcustomer` (
  ...
  `customer_trade_name` varchar(50) DEFAULT NULL,
  ...
  `customer_adress_type` varchar(50) NOT NULL,
  `customer_adress` varchar(50) NOT NULL,
  `customer_adress_complements` varchar(50) DEFAULT NULL,
...
CREATE TABLE `tbpo` (
  ...
  CONSTRAINT `tbpo_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `tbcustomer` (`customer_id`)
...
-- Dump completed on 2019-02-04 18:40:50
